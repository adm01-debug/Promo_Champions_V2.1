          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex gap-2 mt-2">
                <Badge
                  variant="outline"
                  className="text-[9px] uppercase font-bold border-chart-2/30 text-chart-2 bg-chart-2/5"
                >
                  {stats.roleDistribution.salesperson} Vendedores
                </Badge>
                <Badge
                  variant="outline"
                  className="text-[9px] uppercase font-bold border-muted text-muted-foreground"
                >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={cn(
                  'text-3xl font-black',
                  stats.pendingApprovals > 0 ? 'text-warning' : 'text-success'
                )}
              >
                {animatedApprovals}
              </p>
              <p className="text-[10px] text-muted-foreground mt-2 font-medium uppercase tracking-tighter">
                {stats.pendingApprovals > 0
                  ? 'Aguardando aprovação de metas/comissões'
                  : 'Processos comerciais em dia'}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={cn(
                  'text-3xl font-black',
                  animatedAccessDenied > 0 ? 'text-destructive' : 'text-muted-foreground'
                )}
              >
                {animatedAccessDenied}
              </p>
              <div className="flex gap-2 mt-2">
                <Badge
                  variant="outline"
                  className="text-[9px] uppercase font-bold text-destructive border-destructive/30 bg-destructive/5"
                >
                  {stats.securityAlertsCount} Alertas
                </Badge>
                <Badge
                  variant="outline"
                  className="text-[9px] uppercase font-bold text-warning border-warning/30 bg-warning/5"
                >

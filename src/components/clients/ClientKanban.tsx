...
const STAGES = [
  { id: 'active', label: 'Ativo', color: 'bg-green-500/10 border-green-500/30 text-green-700 dark:text-green-400' },
  { id: 'nurturing', label: 'Nutrição', color: 'bg-blue-500/10 border-blue-500/30 text-blue-700 dark:text-blue-400' },
  { id: 'at_risk', label: 'Em Risco', color: 'bg-amber-500/10 border-amber-500/30 text-amber-700 dark:text-amber-400' },
  { id: 'inactive', label: 'Inativo', color: 'bg-red-500/10 border-red-500/30 text-red-700 dark:text-red-400' },

      ...
      <CardContent className="pt-8 relative z-10">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <div className="h-1 flex-1 bg-white/10 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${payload[0].payload.percentage}%` }}
                            />
                          </div>
        ...
        <div className="mt-8 grid grid-cols-5 gap-2">
          {funnelData?.map(item => (
            ...
            >
              <div className="text-xs font-mono font-black tabular-nums text-foreground">
                {item.count}
              </div>
              <div className="text-[8px] font-mono font-bold text-muted-foreground uppercase tracking-widest truncate mt-1 group-hover/item:text-primary transition-colors">
                {item.stage}
              </div>

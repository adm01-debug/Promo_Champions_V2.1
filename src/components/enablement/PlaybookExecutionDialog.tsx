                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p
                              className={`text-sm font-medium leading-relaxed ${isCompleted ? 'line-through text-muted-foreground' : 'text-foreground'}`}
                            >
                              {item.content}
                            </p>
                            <div className="flex items-center gap-2 mt-2">
                              {item.item_type === 'asset' && (
                                <Badge
                                  variant="outline"
                                  className="text-[9px] gap-1 bg-primary/5 text-primary border-primary/20"
                                >
                              ...
                              {item.is_required && (
                                <Badge
                                  variant="outline"
                                  className="text-[9px] bg-destructive/5 text-destructive border-destructive/20"
                                >
                                  Obrigatório
                                </Badge>
                              )}

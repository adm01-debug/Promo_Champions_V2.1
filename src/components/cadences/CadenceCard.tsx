        ...
        <div className="flex flex-wrap gap-1.5 mb-2">
          {steps.slice(0, 5).map((step) => {
            ...
            return (
              <div
                key={step.id}
                className={`flex items-center gap-1 px-2 py-1 rounded-md text-[10px] border ${actionColors[step.action_type]}`}
              >
          ...
          {steps.length > 5 && (
            <div className="px-2 py-1 rounded-md text-[10px] bg-muted text-muted-foreground">
              +{steps.length - 5}
            </div>
          )}
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs font-medium mt-0.5">{step.title}</p>
                    {step.description && (

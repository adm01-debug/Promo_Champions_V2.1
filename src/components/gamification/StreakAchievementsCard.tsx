...
function StreakAchievementsCardImpl({ salespersonId, compact = false }: StreakAchievementsCardProps) {
...
export const StreakAchievementsCard = React.memo(StreakAchievementsCardImpl);

...
export function DailyChallengesCard({
  ...
  const { data: rawChallenges, isLoading } =
    useDailyChallengesWithProgress(salespersonId);
                    ...
                    <div className="relative h-2.5 bg-muted/40 rounded-full overflow-hidden border border-white/5 shadow-inner">
                      <div
                        className={cn(
                          ...
                          challenge.isCompleted
                            ? 'bg-status-success shadow-[0_0_10px_rgba(34,197,94,0.3)]'
                            : 'bg-primary'
                        )}
                    ...
                    {canClaim && (
                      ...
                      >
                        <Button
                          size="sm"
                          onClick={() =>
                            handleClaimReward(challenge.id, challenge.xp_reward)
                          }

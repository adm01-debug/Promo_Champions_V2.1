...
export const closerMainItems: MenuItem[] = [
  ...
  { title: "Acompanhamento", url: "/acompanhamento-pedidos", icon: Package },
...
export const gestaoGroupedItems: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Win/Loss Analysis", url: "/analytics/win-loss", icon: Trophy },
  ...
  {
    label: "Social & Gamificação", icon: PartyPopper,
    items: [
      { title: "Vitórias (Feed)", url: "/victory-feed", icon: Trophy },
      { title: "Equipe (Activity)", url: "/team-activity", icon: Rss },
...
export const adminOnlyItems: MenuItem[] = [
  ...
  { title: "Auditoria de Premiações", url: "/admin/premiacoes/auditoria", icon: ScrollText },

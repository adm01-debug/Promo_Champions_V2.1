...
import { Shield, Zap, Target, Crown, Flame, Gem } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export const AchievementBadgeDisplay: React.FC = () => {
  const badges = [
    {
      ...
      desc: 'Performance Explosiva: Batendo 150% da meta global.',
    },
    {
      id: 2,
      name: 'Overclock',
      ...
      desc: 'Modo Overclock: Atividades de alta densidade registradas.',
    },
    {
      id: 3,
      name: 'Iron Fortress',
      ...
      desc: 'Consistência de Ferro: 7 dias consecutivos em alto nível.',
    },
    {
      id: 4,
      name: 'Circuito Emperor',
      icon: Crown,
      color: 'text-rank-gold',
      bg: 'bg-rank-gold/10',
      border: 'border-rank-gold/30',
      desc: 'Top 1 Absoluto: Dominando o ranking do circuito.',
    },
  ];
  ...
  return (
    <Card
      variant="glass"
      className="border-border/20 bg-background/20 backdrop-blur-xl group/achievements hover:bg-background/30 transition-all duration-700 overflow-hidden relative"
    >
                ...
                <Tooltip delayDuration={0}>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      <badge.icon
                        className={cn(
                          'h-7 w-7 transition-all duration-500 group-hover/badge:scale-110',
                          badge.color,
                          'drop-shadow-glow'
                        )}
                      />
                  ...
                  <TooltipContent className="glass-morphism border-primary/20 p-4 max-w-[200px] shadow-2xl animate-in zoom-in-95">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <div
                          className={cn('p-1 rounded bg-background border', badge.border)}
                        >

...
import { BarChart3, ChevronDown, ChevronUp, Activity, TrendingUp } from 'lucide-react';
import {
  BarChart,
  Bar,
  XAxis,
...
export function ActivityStatsCharts({
  typeStats,
  outcomeStats,
  showStats,
  onToggle,
}: ActivityStatsChartsProps) {
                  ...
                  {Object.entries(typeStats).map(([type, count]) => {
                    ...
                    return (
                      <Badge
                        key={type}
                        variant="secondary"
                        className="bg-background/40 hover:bg-background/60 transition-colors border-border/10 text-[9px] font-black uppercase py-1 px-2.5 gap-1.5 shadow-sm"
                      >
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            activeIndex === i
                              ? 'bg-muted/50 border-border/20 shadow-sm translate-x-1'
                              : 'opacity-70'
                          )}

                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="left" className="max-w-xs">
                          <div className="space-y-2 p-1">
                            ...
                            {!lead.labels && (
                              <FactorBar label="Valor do Deal" value={((lead.factors as Record<string, number>)).dealValue} maxValue={25} />
                            )}
                          </div>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="left" className="max-w-xs">
                          <div className="space-y-2 p-1">
                            ...
                            <FactorBar label="Empresa" value={((lead.factors as Record<string, number>)).companySize} maxValue={20} />
                            <FactorBar label="Indústria" value={((lead.factors as Record<string, number>)).industry} maxValue={15} />
                            <FactorBar label="Engajamento" value={((lead.factors as Record<string, number>)).engagement} maxValue={25} />
                            <FactorBar label="Origem" value={((lead.factors as Record<string, number>)).source} maxValue={10} />
                          </div>
                        </TooltipContent>
                      </Tooltip>
                    )}

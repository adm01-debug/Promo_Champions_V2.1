...
export const LeadNeuralDossier = ({ lead, isOpen, onClose }: LeadNeuralDossierProps) => {
  ...
  const exportDossierCSV = () => {
    ...
    try {
      ...
      link.setAttribute(
        'download',
        `neural_dossier_${lead.name.replace(/\s+/g, '_').toLowerCase()}.csv`
      );
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <DialogTitle className="text-section-title font-black uppercase tracking-tighter italic flex items-center gap-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] font-black tracking-widest bg-primary/5 border-primary/20 text-primary"
                    >
                      DOSSIÊ NEURAL
                    </Badge>
                  </DialogTitle>
              ...
              <div className="hidden lg:flex items-center gap-6 pr-8">
                <div className="text-right">
                  ...
                  <p className="font-display font-black text-2xl italic text-primary">
                    #TOP TIER
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 grid grid-cols-2 gap-4">
                <div className="p-5 rounded-2xl bg-card/40 border border-white/5 shadow-inner group transition-all hover:bg-card/60">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-display font-black italic text-primary">
                      {lead.score}
                    </span>
                      ...
                      {[1, 2, 3, 4, 5].map(i => (
                        <div
                          ...
                          className={cn(
                            ...
                            i <= lead.score / 20 ? 'bg-primary' : 'bg-white/5'
                          )}
                        />
                      ))}
                    </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge variant="outline" className="text-[8px] font-black opacity-50">
                    REAL-TIME
                  </Badge>
                </div>
                ...
                <div className="relative flex items-center justify-center py-2">
                  <svg className="w-24 h-24 transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeDashoffset={
                        251.2 - (251.2 * (lead.churnRisk?.risk_score || 0)) / 100
                      }
                      strokeLinecap="round"
                      className={cn(
                        'transition-all duration-1000',
                        (lead.churnRisk?.risk_score || 0) > 50
                          ? 'text-status-error'
                          : 'text-emerald-500'
                      )}
                    />
            ...
            <div className="pt-6 border-t border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-bold text-muted-foreground/40 uppercase tracking-[0.2em]">
                  Data Source: Neural Analytics Engine v4.0.2 / Hash:{' '}

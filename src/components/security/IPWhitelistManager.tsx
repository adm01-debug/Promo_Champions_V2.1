...
import { Shield, Plus, Trash2, Globe, Clock, ShieldCheck } from "lucide-react";
...
const ipSchema = z.object({
  ip_address: z
    ...
    .regex(
      /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(?:\/(?:[0-9]|[1-2][0-9]|3[0-2]))?$|^(?:[a-fA-F0-9]{1,4}:){7}[a-fA-F0-9]{1,4}$/,
      "Formato de IP inválido. Use IPv4 (ex: 192.168.1.1) ou CIDR (ex: 192.168.1.0/24)"
    ),
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>
                IPs autorizados a acessar o sistema sem restrições
              </CardDescription>
            </div>
          </div>
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Este IP terá acesso irrestrito ao sistema
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Suporta IPv4 e notação CIDR (ex: 192.168.1.0/24)
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="description"
                    placeholder="Ex: Escritório principal, VPN corporativa..."
        ...
        {whitelistedIPs && whitelistedIPs.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Adicione IPs confiáveis para acesso irrestrito ao sistema
            </p>

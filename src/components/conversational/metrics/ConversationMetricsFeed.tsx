      ...
      <Card variant="modern">
        <CardHeader className="flex flex-col gap-3 pb-3 sm:flex-row sm:items-center sm:justify-between">
          <CardTitle className="text-section-title">
            Feed de métricas conversacionais
          </CardTitle>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="py-8 text-center text-sm text-muted-foreground">
              Nenhuma métrica conversacional encontrada. Transcreva e analise gravações
              para popular este feed.
            </p>
          ) : (
                ...
                <div key={r.id} className="flex items-center justify-between gap-3 py-3">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant={healthBadgeVariant(r.health)}>
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-[10px] text-muted-foreground">
                      {formatDistanceToNow(new Date(r.calculated_at), {
                        addSuffix: true,
                        locale: ptBR,
                      })}
                    </div>

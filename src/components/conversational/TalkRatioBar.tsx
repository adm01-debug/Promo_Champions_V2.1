    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          {tooMuch ? (
            <Badge className="bg-destructive/10 text-destructive border-destructive/20 text-[8px] font-black py-0 h-4">
              OVER-TALKING DETECTED
            </Badge>
          ) : idealZone ? (
            <Badge className="bg-success/10 text-success border-success/20 text-[8px] font-black py-0 h-4">
              OPTIMAL ENGAGEMENT
            </Badge>
          ) : (
            <Badge className="bg-primary/10 text-primary border-primary/20 text-[8px] font-black py-0 h-4">
              UNBALANCED
            </Badge>
          )}
        </div>
      ...
      <div className="flex items-center justify-between text-[11px] font-black tracking-tight uppercase">
        <div className="flex items-center gap-1.5 text-primary">
          ...
          Vendedor{' '}
          <span className="tabular-nums font-black opacity-80">{s.toFixed(1)}%</span>
        </div>
        <div className="flex items-center gap-1.5 text-accent">
          Cliente{' '}
          <span className="tabular-nums font-black opacity-80">{c.toFixed(1)}%</span>

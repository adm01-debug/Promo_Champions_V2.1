...
import { useDealHealth } from '@/hooks/deal-intelligence/useDealHealth';
                    ...
                    >
                      <div className="p-2 rounded-lg bg-black/40 border border-white/5">
                        ...
                        <p className="text-[11px] text-muted-foreground leading-relaxed">
                          Baseado em 42 deals similares, o playbook recomenda focar no
                          argumento de "ROI em 6 meses" usando o case da TechCorp.
                        </p>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <Button
                          size="sm"
                          className="h-7 px-3 text-[10px] font-bold uppercase tracking-widest gap-1 bg-primary text-primary-foreground"
                        >
        ...
        <div className="p-3 rounded-lg bg-secondary/30 border border-dashed border-border/40">
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed italic">
            ...
            {health?.ai_recommendation ||
              'Baseado na falta de interação nos últimos 5 dias e na ausência do Comprador Econômico no comitê, o deal apresenta 65% de chance de estagnação. Ações sugeridas visam retomar o momentum e blindar a conta contra concorrentes citados.'}
            "
          </p>
        </div>
      </CardContent>

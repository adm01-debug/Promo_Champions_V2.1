  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Hub unificado de coaching com priorização automática por IA e recomendações personalizadas para cada vendedor" />
      </Helmet>
      <div className="p-6 space-y-6">
        {/* Header */}
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Priorização automática: quem precisa de atenção agora e o que fazer
            </p>
          </div>
        </div>

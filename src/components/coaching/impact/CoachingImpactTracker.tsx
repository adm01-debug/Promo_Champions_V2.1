...
function KpiCard({
  ...
  return (
    <Card className="p-4">
      ...
      <p className={`text-2xl font-display font-bold ${tone ?? 'text-foreground'}`}>
        {value}
      </p>
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <KpiCard
          icon={Target}
          label="Sessões medidas"
          value={summary.total_sessions.toString()}
          hint="janela 30d antes/depois"
        />
        <KpiCard
          icon={TrendingUp}
          label="Δ Score médio"

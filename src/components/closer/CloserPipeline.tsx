    ...
    <Card className="glass border-primary/20 bg-black/40 backdrop-blur-xl relative overflow-hidden group">
      ...
      <CardHeader className="pb-4 border-b border-white/5 relative z-10">
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className="font-mono text-[9px] font-black uppercase tracking-widest bg-primary/10 border-primary/30 text-primary"
          >
            {totalDeals} UNITS
          </Badge>
        </div>
      ...
      <CardContent className="space-y-6 pt-6 relative z-10">
        {pipeline?.map((stage, index) => {
          ...
          const isLargestValue =
            stage.value === Math.max(...(pipeline?.map(p => p.value) || [0]));
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isLargestValue &&
                  'bg-white/[0.03] border-white/5 shadow-[0_0_15px_rgba(255,255,255,0.02)]'
              )}
            >
              <div className="flex items-center justify-between">
        ...
        <div className="pt-6 border-t border-white/5 mt-4">
          <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-primary/10 to-accent/5 border border-primary/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[9px] font-mono font-bold text-primary uppercase tracking-[0.2em]">
                  Active Exposure
                </p>
            ...
            <div className="text-right">
              <Badge
                variant="outline"
                className="text-[9px] font-mono font-black border-success/30 text-success bg-success/10 uppercase tracking-widest"
              >
                OPTIMIZED
              </Badge>
            </div>

    ...
    <motion.div whileHover={{ y: -4, transition: { duration: 0.2 } }} className="h-full">
      <Card
        className={cn(
          ...
          styles.border,
          hero &&
            'md:col-span-2 border-primary/20 bg-primary/[0.02] shadow-[0_0_30px_rgba(14,165,233,0.05)]',
      ...
      >
        ...
        <CardContent className={cn('p-5 relative z-10', hero && 'sm:p-8')}>
          <div className="flex items-start justify-between">
              ...
              <div className="flex flex-col gap-1">
                <motion.span
                  ...
                  className={cn(
                    ...
                    styles.text,
                    hero &&
                      'bg-clip-text text-transparent bg-gradient-to-br from-primary via-primary-glow to-primary'
                  )}
                  style={{
            ...
            >
              <Icon className={cn('h-5 w-5', styles.text, hero && 'h-8 w-8')} />
            </div>
          </div>
        </CardContent>
      </Card>

      ...
      <CardHeader className="pb-4 border-b border-border/30 relative z-10">
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            ...
            <Badge
              variant="secondary"
              className="text-[10px] font-black uppercase tracking-widest bg-primary/10 text-primary border border-primary/20 shadow-sm px-3 py-1"
            >
        ...
        <ScrollArea className="h-[480px]">
          <div className="p-4 space-y-5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] uppercase font-black tracking-widest text-muted-foreground/60 leading-none mt-1">
                          Status de Dominação
                        </span>
                      </div>
                    </div>
            ...
            {withGoals.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-muted-foreground glass rounded-xl animate-fade-in">
                ...
                <p className="text-xs mt-1 text-muted-foreground/70">
                  Configure metas para os vendedores
                </p>
              </div>
            ) : (
              <div className="space-y-3">
                <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest mb-2 px-1">
                  Geral
                </p>
            ...
            {withoutGoals.length > 0 && withGoals.length > 0 && (
              <div
                className="pt-4 border-t border-border/40 animate-fade-in"
                style={{ animationDelay: `${withGoals.length * 50 + 100}ms` }}
              >
                ...
                {withoutGoals.map((sp, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="animate-fade-in"
                      style={{
                        animationDelay: `${(withGoals.length + index) * 50 + 150}ms`,
                      }}
                    >
                      <SalespersonGoalCard
                        {...sp}

...
import { Brain, TrendingUp, Clock, DollarSign, Activity, Users } from 'lucide-react';
...
export const ExplainableWinProbability = React.memo(
  ({
    ...
    const factors = useMemo((): WinProbabilityFactor[] => {
      ...
      // Deal size
      const sizeImpact =
        dealAmount > 100000 ? -10 : dealAmount > 50000 ? -5 : dealAmount > 10000 ? 5 : 10;
      f.push({
        name: 'Valor do Deal',
        impact: sizeImpact,
        icon: DollarSign,
      ...
      f.push({
        ...
        description: hasRecentActivity
          ? 'Interação recente registrada'
          : 'Sem atividade recente — risco de esfriar',
      });
      ...
      f.push({
        ...
        icon: Users,
        description: isICPMatch
          ? 'Cliente alinhado ao perfil ideal'
          : 'Cliente fora do perfil ideal',
      });

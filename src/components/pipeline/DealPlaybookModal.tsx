    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] glass border-border/40 dark:border-glow p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-0">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <DialogDescription>
                Guia estratégico para{' '}
                <span className="text-foreground font-semibold">{clientName}</span> na
                etapa{' '}
                <span className="text-primary font-medium uppercase tracking-wider text-xs">
                  {stageId}
                </span>
              </DialogDescription>
            </div>
          ...
          <div className="mb-8 p-4 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 shadow-xl relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">
                Diretriz Estratégica IA
              </span>
            </div>

            <div className="space-y-3 relative z-10">
              <p className="text-sm font-semibold leading-relaxed">
                "Este cliente valoriza{' '}
                ...
                . Foque em demonstrar o tempo de payback menor que 6 meses."
              </p>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="p-2 rounded-lg bg-emerald-500/5 border border-emerald-500/10">
                  ...
                  <p className="text-[11px] font-medium">
                    Escalabilidade técnica provada no case X.
                  </p>
                </div>
                <div className="p-2 rounded-lg bg-amber-500/5 border border-amber-500/10">
                  ...
                  <p className="text-[11px] font-medium">
                    Curva de aprendizado do time operacional.
                  </p>
                </div>
              </div>
            </div>
          ...
          {loadingPlaybooks || loadingProgress ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Nenhum playbook definido para esta etapa.
              </p>
            </div>
          ) : (
        ...
        <div className="p-4 bg-muted/10 border-t border-border/20 flex justify-end">
          <Badge
            variant="secondary"
            className="bg-primary/10 text-primary border-none text-[10px] font-black uppercase tracking-widest px-3"
          >

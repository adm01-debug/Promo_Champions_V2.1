...
export const FeatureComparison = () => {
  const comparisons = [
    {
      ...
      competitor_evidence:
        'Base própria com +10M de decisores brasileiros. Captura via redes sociais corporativas.',
      priority: 'high',
      effort: 'high',
      impact: 'high',
    ...
    },
    {
      ...
      status: 'gap',
      our_evidence:
        'Mapeado: Gatilhos baseados em abertura de propostas e cliques em links.',
      competitor_evidence:
        'Alertas em tempo real quando o lead interage com o e-mail ou proposta.',
      priority: 'critical',
      effort: 'medium',
      impact: 'very-high',
    },
    {
      ...
      status: 'full',
      our_evidence:
        'Follow-up inteligente com WhatsApp, registro de tentativas e automação de status.',
      competitor_evidence:
        'Geração de número de decisores e integração de cadência multicanal nativa.',
      priority: 'done',
      effort: 'medium',
      impact: 'high',
    },
    {
      ...
      competitor_evidence:
        "IA para análise de perfil comportamental e sugestão do 'momento certo' para ligar.",
      priority: 'critical',
      effort: 'medium',
      impact: 'very-high',
    },
    {
      ...
      competitor_evidence:
        'Análise de sentimento básica e categorização de respostas automáticas.',
      priority: 'medium',
      effort: 'high',
      impact: 'high',
    },
    {
      ...
      competitor_evidence:
        'Foco em CRM tradicional, sem camada social/gamificada avançada.',
      priority: 'done',
      effort: 'very-high',
      impact: 'high',
    },
  ...
  const roadmap = [
    {
      goal: 'AI Engagement Score',
      impact: 'Very High',
      effort: 'Medium',
      status: 'Planning',
      recommendation: 'Implementar algoritmo de calor baseado em aberturas/cliques.',
    },
    {
      goal: 'SINGU Database Sync',
      impact: 'Critical',
      effort: 'High',
      status: 'Backlog',
      recommendation: 'Sincronização bidirecional total com a base de decisores SINGU.',
    },
    {
      goal: 'Automated Bounce Cleanup',
      impact: 'High',
      effort: 'Low',
      status: 'Research',
      recommendation:
        'Trigger automático para marcar lead como bounce após erro 4xx/5xx no envio.',
    },
    {
      goal: 'AI behavioral approach',
      impact: 'Medium',
      effort: 'Medium',
      status: 'Backlog',
      recommendation: 'Sugestão de templates baseada no cargo/setor do decisor.',
    },
  ];
    ...
    switch (status) {
      ...
      case 'gap':
        return (
          <Badge
            variant="destructive"
            className="bg-rose-500/20 text-rose-400 border-rose-500/30 gap-1"
          >
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      case 'critical':
        return <Badge className="bg-rose-500 text-white animate-pulse">Critical</Badge>;
      case 'high':
  ...
  const handleExportPDF = () => {
    ...
    setTimeout(() => {
      toast.info(
        'O PDF será baixado em instantes com análise detalhada, evidências e roadmap.'
      );
    }, 1500);
  };
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-1">
          ...
          <h2 className="text-4xl font-black italic tracking-tighter uppercase gradient-text leading-none">
            Market Analysis
          </h2>
          <p className="text-muted-foreground text-sm font-medium">
            Análise comparativa de paridade funcional e roadmap estratégico.
          </p>
        </div>
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            size="sm"
            className="gap-2 h-10 px-4 border-white/5 bg-white/5 hover:bg-white/10 transition-all text-xs font-bold uppercase tracking-widest"
          ...
          <Button
            size="sm"
            className="gap-2 h-10 px-4 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20 transition-all text-xs font-bold uppercase tracking-widest"
          >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 group/item">
                  ...
                  <span className="text-sm text-muted-foreground font-medium group-hover/item:text-foreground transition-colors">
                    {item.text}
                  </span>
                </li>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription className="text-xs font-medium">
                  Detailed audit vs. Ramper Prospect
                </CardDescription>
              </div>
              <Badge
                variant="outline"
            ...
            <Table>
              <TableHeader className="bg-white/5">
                <TableRow className="hover:bg-transparent border-white/5">
                  <TableHead className="w-[180px] text-[10px] uppercase font-black tracking-widest text-muted-foreground py-4 px-6">
                    Feature
                  </TableHead>
                  <TableHead className="text-[10px] uppercase font-black tracking-widest text-muted-foreground py-4">
                    Status
                  </TableHead>
                  <TableHead className="text-[10px] uppercase font-black tracking-widest text-muted-foreground py-4">
                    Evidence (Ours)
              ...
              <TableBody>
                {comparisons.map((item, index) => (
                  <TableRow
                    key={index}
                    className="group/row hover:bg-white/5 border-white/5 transition-colors"
                  >
                    <TableCell className="font-bold text-sm px-6 py-4">
                      {item.feature}
                    </TableCell>
                            ...
                            <div className="p-8">
                              ...
                              <div className="mt-6 flex items-center justify-between">
                                <p className="text-xs text-muted-foreground italic font-medium">
                                  Captura realizada em ramper.com.br/prospect
                                </p>
                                <Badge
                                  variant="outline"
        ...
        <Card className="glass border-white/5 overflow-hidden flex flex-col">
          <CardHeader className="border-b border-white/5 bg-white/5">
            ...
            <CardDescription className="text-xs font-medium">
              Strategic parity execution plan
            </CardDescription>
          </CardHeader>
            ...
            {roadmap.map((item, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <h4 className="font-black text-xs uppercase tracking-tighter italic group-hover:text-primary transition-colors">
                    {item.goal}
                  </h4>
                  <Badge
                    variant="outline"
                    className="text-[8px] uppercase font-bold border-white/10 bg-black/40"
                  >
                    {item.status}
                  </Badge>
                </div>
                ...
                <div className="flex gap-4 pt-3 border-t border-white/5">
                  <div className="flex-1">
                    <p className="text-[8px] text-muted-foreground uppercase font-black tracking-widest mb-1">
                      Impact
                    </p>
...
const Brain = (props: import('react').SVGProps<SVGSVGElement>) => (
  <svg
    {...props}

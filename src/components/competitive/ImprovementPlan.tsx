  ...
  const steps = [
    {
      ...
      description:
        'Integrar a base de dados do sistema SINGU para eliminar a dependência de buscas externas manuais e centralizar decisores B2B.',
    ...
    },
    {
      ...
      description:
        'Desenvolver scraper inteligente que valide e-mails e telefones em tempo real ao capturar leads do Linkedin.',
      focus: 'Data Quality',
      impact: 'Very High',
      effort: 'Medium',
      icon: Search,
    },
    {
      ...
      description:
        'Criar algoritmo que priorize leads baseado em interações anteriores (aberturas, cliques, tempo de resposta).',
      focus: 'AI Analytics',
      impact: 'High',
      effort: 'Medium',
      icon: BarChart3,
    },
    {
      ...
      description:
        'Iniciar cadências ou criar tarefas de alta prioridade automaticamente quando um lead interage com propostas ou abre anexos repetidamente.',
      focus: 'Conversion',
      impact: 'Critical',
      effort: 'High',
      icon: Zap,
    },
    {
      ...
      description:
        'Integrar tarefas manuais de ligação e mensagens de voz no WhatsApp dentro do fluxo, garantindo uma abordagem humana e persistente.',
      focus: 'Sales Results',
      impact: 'High',
      effort: 'Medium',
      icon: LinkIcon,
    },
    {
      ...
      description:
        'Análise de sentimentos em respostas para sugerir automaticamente scripts de contorno de objeções baseados em cases de sucesso.',
      focus: 'Closing',
      impact: 'High',
      effort: 'High',
      icon: MessageSquare,
    },
    {
      ...
      description:
        'Visualização clara do custo por lead vs. fechamento em comparação com benchmarks do mercado.',
      focus: 'Management',
      impact: 'High',
      effort: 'Medium',
      icon: Target,
    },
    {
      ...
      description:
        'Melhorar conectores com Salesforce, HubSpot e Pipedrive para evitar duplicidade de dados.',
      focus: 'Integrations',
      impact: 'Very High',
      effort: 'High',
      icon: Users,
    },
    {
      ...
      description:
        'Transformar a descoberta de leads em missões diárias na Arena Competitiva com recompensas reais.',
      focus: 'Performance',
      impact: 'High',
      effort: 'Medium',
      icon: Zap,
    },
    {
      ...
      description:
        'Geração automática de PDFs mensais com gaps de produtividade e sugestões de melhoria de script.',
      focus: 'Strategy',
      impact: 'Medium',
      effort: 'Low',
      icon: CheckCircle2,
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground text-sm font-medium">
          Roteiro estratégico para atingir a paridade e superar a concorrência.
        </p>
      </div>
            ...
            <Card className="group hover:border-primary/40 transition-all duration-500 glass overflow-hidden relative">
              ...
              <CardHeader className="pb-2 relative z-10">
                <div className="flex justify-between items-start">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[9px] uppercase font-black border-primary/20 bg-primary/5 px-2 py-0.5"
                  >
                    {item.impact} Impact
                  </Badge>
                </div>

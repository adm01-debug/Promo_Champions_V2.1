...
const DailyMissionsComponent: FC<DailyMissionsProps> = ({ salespersonId, className }) => {
  const { missions, isLoading, claimXP, completedCount, totalCount } =
    useDailyMissions(salespersonId);
      ...
      <Card className="border-dashed">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Missões são geradas automaticamente todos os dias às 6h
          </p>
        </CardContent>
      </Card>
    );
                ...
                <div className="text-right hidden md:block">
                  ...
                  <p
                    className={cn(
                      ...
                      allCompleted ? 'text-emerald-400' : 'text-primary'
                    )}
                  >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-medium opacity-80 uppercase tracking-widest">
                      Você dominou todas as frentes de hoje. Retorne amanhã para novos
                      desafios.
                    </p>
                  </div>
              ...
              >
                ...
                <div className="space-y-4 relative z-10">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-[0.1em] line-clamp-1">
                      {mission.description}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-1.5 w-full bg-black/20 rounded-full overflow-hidden border border-white/5">
                      <motion.div
                        ...
                        className={cn(
                          'h-full',
                          mission.completed ? 'bg-emerald-500' : 'bg-primary'
                        )}
                      />
                    </div>
                  </div>

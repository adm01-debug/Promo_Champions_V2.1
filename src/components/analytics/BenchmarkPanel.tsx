...
import { Minus, ArrowUpRight, ArrowDownRight, Activity, Zap } from 'lucide-react';
          ...
          {benchmarks.map((b, idx) => (
            ...
            >
              <div className="relative z-10">
                <p className="text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-muted-foreground/60 mb-1 group-hover/item:text-muted-foreground transition-colors">
                  {b.metric}
                </p>
                <p className="text-xl font-mono font-black tracking-tighter tabular-nums">
                  {formatValue(b.current, b.format)}
                </p>

...
const MarkerClusterGroup = memo(function MarkerClusterGroup({
  clients,
}: {
  ...
  useEffect(() => {
    ...
    const cluster = L.markerClusterGroup({
      ...
      iconCreateFunction: c => {
        ...
        const sz = count > 50 ? 48 : count > 10 ? 40 : 32;
        return L.divIcon({
          html: `<div style="
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Slider
                ...
                min={0}
                max={CLIENT_MAP.SLIDER_MAX_VALUE}
                step={CLIENT_MAP.SLIDER_STEP}
              />

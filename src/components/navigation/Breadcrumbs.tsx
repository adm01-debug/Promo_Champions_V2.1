...
export const Breadcrumbs = memo(
  forwardRef<HTMLElement>(function Breadcrumbs(_props, ref) {
                      ...
                      {index > 0 && (
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="start" className="w-48 p-1 glass">
                            <DropdownMenuLabel className="text-[9px] uppercase tracking-widest opacity-50 px-2 py-1.5">
                              Mudar para
                            </DropdownMenuLabel>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              {isFirst ? (
                                <Home
                                  className="h-3.5 w-3.5 group-hover/item:scale-110 transition-transform duration-300"
                                  aria-hidden="true"
                                />
                              ) : (

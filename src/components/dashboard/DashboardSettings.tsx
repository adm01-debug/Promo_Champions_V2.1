          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-primary/20 pb-2">
              ...
              {isSyncing ? (
                ...
                <div className="text-[8px] font-mono text-success/70">
                  CLOUDSYNC ACTIVE
                </div>
              )}
            </div>
            ...
            <div className="space-y-3 pt-2 border-t border-primary/10">
              <div className="flex items-center justify-between">
                <h5 className="text-[9px] font-mono font-bold uppercase text-primary/80">
                  Thresholds & Alertas
                </h5>
                <Button
                  variant="ghost"
              ...
              <div className="space-y-1.5">
                <label className="text-[8px] font-mono uppercase text-muted-foreground">
                  Frequência
                </label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background/95 backdrop-blur-3xl border-border/40">
                    ...
                    <SelectItem value="daily" className="text-[10px] font-mono uppercase">
                      Diário
                    </SelectItem>
                    <SelectItem
                      value="weekly"
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <SelectContent className="bg-background/95 backdrop-blur-3xl border-border/40">
                    ...
                    <SelectItem value="kilo" className="text-[10px] font-mono uppercase">
                      Abreviação (k)
                    </SelectItem>
                  </SelectContent>
                </Select>

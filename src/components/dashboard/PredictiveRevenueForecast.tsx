...
import { Brain, AlertTriangle, Lightbulb, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="mt-2 space-y-1">
            <div className="flex justify-between text-[10px] text-muted-foreground uppercase tracking-wider">
              ...
              <span>
                {Math.round(
                  (forecast?.scenarios.realistic / forecast?.metrics.goal_for_horizon) *
                    100
                )}
                %
              </span>
          ...
          >
            <div className="flex gap-2">
              ...
              <p className="text-xs leading-relaxed text-muted-foreground italic">
                {forecast?.narrative ||
                  'Analisando tendências de pipeline e histórico de conversão...'}
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-1.5">
                  {forecast?.risks?.map((risk: string, i: number) => (
                    <li
                      key={i}
                      className="text-[10px] leading-tight text-muted-foreground flex gap-1 items-start"
                    >

      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between gap-8">
          <div className="flex items-center gap-2 text-xs">
            ...
            <span className="text-muted-foreground font-mono uppercase tracking-tighter">
              Revenue
            </span>
          </div>
          <span className="font-mono font-bold text-primary tabular-nums">
            R${' '}
            {Number(point.revenue).toLocaleString('pt-BR', { maximumFractionDigits: 0 })}
          </span>
        </div>
        <div className="flex items-center justify-between gap-8">
          <div className="flex items-center gap-2 text-xs">
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p
          className={cn(
            'text-base font-bold font-mono tracking-tighter tabular-nums',
            accentColor
          )}
        >
          {value}
      ...
      <motion.div
        ...
        transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
        style={{
          color: accent === 'primary' ? 'hsl(var(--primary))' : 'hsl(var(--success))',
        }}
      />
    </div>
  );

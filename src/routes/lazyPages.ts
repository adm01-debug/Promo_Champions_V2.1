...
type PrefetchImport = () => Promise<{ default: ComponentType<unknown> }>;

type PrefetchableComponent = LazyExoticComponent<ComponentType<unknown>> & {
  prefetch: PrefetchImport;
};
...
export const lazyWithPrefetch = (
  importStatement: PrefetchImport
): PrefetchableComponent => {
  const Component = lazy(importStatement) as PrefetchableComponent;
  Component.prefetch = importStatement;
  return Component;
};
...
export const VendedorDashboard = lazyWithPrefetch(
  () => import('@/pages/VendedorDashboard')
);
...
export const FollowUpInteligente = lazyWithPrefetch(
  () => import('@/pages/FollowUpInteligente')
);
...
export const SendTimeOptimization = lazyWithPrefetch(
  () => import('@/pages/SendTimeOptimization')
);
export const EmailEngagementScoring = lazyWithPrefetch(
  () => import('@/pages/EmailEngagementScoring')
);
...
export const ConversationalIntelligence = lazyWithPrefetch(
  () => import('@/pages/ConversationalIntelligenceHub')
);
export const RevenueIntelligence = lazyWithPrefetch(
...
export const AccountBasedEngagement = lazyWithPrefetch(
  () => import('@/pages/AccountBasedEngagement')
);
export const AccountDetail = lazyWithPrefetch(() => import('@/pages/AccountDetail'));
export const AutomationBuilder = lazyWithPrefetch(
  () => import('@/pages/AutomationBuilder')
);
export const AutomacaoInteligente = lazyWithPrefetch(
  () => import('@/pages/AutomacaoInteligente')
);

// ─── Vendas & Comercial ─────────────────────────────────────────────
export const Orcamentos = lazyWithPrefetch(() => import('@/pages/Orcamentos'));
export const AssinaturaDigital = lazyWithPrefetch(
  () => import('@/pages/AssinaturaDigital')
);
export const Fornecedores = lazyWithPrefetch(() => import('@/pages/Fornecedores'));
export const ComparadorPrecos = lazyWithPrefetch(
  () => import('@/pages/ComparadorPrecos')
);
...
export const ApprovalWorkflows = lazyWithPrefetch(
...
export const RelatorioAtividades = lazyWithPrefetch(
  () => import('@/pages/RelatorioAtividades')
);
export const RelatoriosEmail = lazyWithPrefetch(() => import('@/pages/RelatoriosEmail'));
export const EmailAnalyticsPage = lazyWithPrefetch(
  () => import('@/pages/EmailAnalyticsPage')
);
export const RelatoriosExecutivos = lazyWithPrefetch(
  () => import('@/pages/RelatoriosExecutivos')
);
export const ScheduledReports = lazyWithPrefetch(
  () => import('@/pages/ScheduledReports')
);
...
export const ForecastPonderado = lazyWithPrefetch(
  () => import('@/pages/ForecastPonderado')
);
...
export const TopProductsRanking = lazyWithPrefetch(
  () => import('@/pages/TopProductsRanking')
);
...
export const HistoricalBenchmark = lazyWithPrefetch(
  () => import('@/pages/HistoricalBenchmark')
);
export const ClientHealthScore = lazyWithPrefetch(
  () => import('@/pages/ClientHealthScore')
);
export const InteligenciaPreditiva = lazyWithPrefetch(
  () => import('@/pages/InteligenciaPreditiva')
);
export const PurchaseIntelligence = lazyWithPrefetch(
  () => import('@/pages/PurchaseIntelligence')
);
export const CoachingInteligente = lazyWithPrefetch(
  () => import('@/pages/CoachingInteligente')
);
export const RevOpsHub = lazyWithPrefetch(() => import('@/pages/RevOpsHub'));
export const DealIntelligence = lazyWithPrefetch(
  () => import('@/pages/DealIntelligence')
);
export const WinLossIntelligence = lazyWithPrefetch(
  () => import('@/pages/WinLossIntelligence')
);
export const WinLossAnalysisPage = lazyWithPrefetch(
  () => import('@/pages/WinLossAnalysisPage')
);
...
export const DealVelocityPage = lazyWithPrefetch(
  () => import('@/pages/DealVelocityPage')
);
export const EvolutionCurvesPage = lazyWithPrefetch(
  () => import('@/pages/EvolutionCurvesPage')
);
export const ObjectionsLibraryPage = lazyWithPrefetch(
  () => import('@/pages/ObjectionsLibraryPage')
);
export const Intelligence = lazyWithPrefetch(() => import('@/pages/Intelligence'));
export const BusinessIntelligencePage = lazyWithPrefetch(
  () => import('@/pages/BusinessIntelligencePage')
);

// ─── Gamificação & Social ───────────────────────────────────────────
export const RankingCompetitivo = lazyWithPrefetch(
  () => import('@/pages/RankingCompetitivo')
);
export const ArenaCompetitiva = lazyWithPrefetch(
  () => import('@/pages/ArenaCompetitiva')
);
...
export const GamifiedProfilePage = lazyWithPrefetch(
  () => import('@/pages/GamifiedProfilePage')
);
export const BadgesGalleryPage = lazyWithPrefetch(
  () => import('@/pages/BadgesGalleryPage')
);
export const RaceArenaAdmin = lazyWithPrefetch(
  () => import('@/pages/admin/RaceArenaAdmin')
);
...
export const DesafiosSemanais = lazyWithPrefetch(
  () => import('@/pages/DesafiosSemanais')
);
export const HistoricoDesafiosDiarios = lazyWithPrefetch(
  () => import('@/pages/HistoricoDesafiosDiarios')
);
export const VictoryFeedPage = lazyWithPrefetch(() => import('@/pages/VictoryFeedPage'));
export const CompetitiveSeasonsAdmin = lazyWithPrefetch(
  () => import('@/pages/CompetitiveSeasonsAdmin')
);
export const TeamActivityFeed = lazyWithPrefetch(
  () => import('@/pages/TeamActivityFeed')
);
...
export const OnboardingTracking = lazyWithPrefetch(
  () => import('@/pages/OnboardingTracking')
);
export const InactivityTriggers = lazyWithPrefetch(
  () => import('@/pages/InactivityTriggers')
);
...
export const FeatureFlagsAdmin = lazyWithPrefetch(
  () => import('@/pages/FeatureFlagsAdmin')
);
export const SecurityDashboard = lazyWithPrefetch(
  () => import('@/pages/SecurityDashboard')
);
export const WebhooksDeadLettersAdmin = lazyWithPrefetch(
  () => import('@/pages/admin/WebhooksDeadLettersAdmin')
);
export const WebhookTimelinePage = lazyWithPrefetch(
  () => import('@/pages/admin/WebhookTimelinePage')
);
export const WebhookAlertHistoryPage = lazyWithPrefetch(
  () => import('@/pages/admin/WebhookAlertHistoryPage')
);
export const WebhookAlertSettingsPage = lazyWithPrefetch(
  () => import('@/pages/admin/WebhookAlertSettingsPage')
);
export const CustomerSuccessHubPage = lazyWithPrefetch(
  () => import('@/pages/CustomerSuccessHub')
);
export const SalesEnablementHubPage = lazyWithPrefetch(
  () => import('@/pages/SalesEnablementHub')
);
export const PricingIntelligenceHubPage = lazyWithPrefetch(
  () => import('@/pages/PricingIntelligenceHub')
);
export const TerritoryOptimizationHubPage = lazyWithPrefetch(
  () => import('@/pages/TerritoryOptimizationHub')
);
export const CustomerSuccess360Page = lazyWithPrefetch(
  () => import('@/pages/CustomerSuccess360')
);
export const AdminConexoesPage = lazyWithPrefetch(
  () => import('@/pages/admin/AdminConexoesPage')
);
...
export const AdminPlatformSLOPage = lazyWithPrefetch(
  () => import('@/pages/admin/AdminPlatformSLOPage')
);
export const AdminWebVitalsPage = lazyWithPrefetch(
  () => import('@/pages/admin/AdminWebVitalsPage')
);
...
export const RetryTestStatusPage = lazyWithPrefetch(
  () => import('@/pages/RetryTestStatusPage')
);

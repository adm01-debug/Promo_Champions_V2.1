  ...
  switch (type) {
    ...
    case 'number':
      return [
        ...
        Infinity,
        -Infinity,
        MAX_SAFE_INTEGER_FUZZ,
        MIN_SAFE_INTEGER_FUZZ,
      ];
    case 'email':
      return [
        'plainaddress',
...
export const runFuzzTest = async <T, I = unknown>(
  fn: (input: I) => Promise<T> | T,
  type: 'string' | 'number' | 'object' | 'email'
) => {

...
function addTopDeals(doc: jsPDF, autoTable: (options: Record<string, unknown>) => void, deals: ReportData["topDeals"], startY: number): number {
  doc.setFontSize(12);
  doc.setFont("helvetica", "bold");
  doc.setTextColor(...BRAND_DARK);
...
function addTeamRanking(doc: jsPDF, autoTable: (options: Record<string, unknown>) => void, team: ReportData["teamRanking"], startY: number): number {
  doc.setFontSize(12);
  doc.setFont("helvetica", "bold");
  doc.setTextColor(...BRAND_DARK);

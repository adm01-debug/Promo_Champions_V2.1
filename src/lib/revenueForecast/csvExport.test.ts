...
const fixture: ForecastResult = {
  history: [
    { period: "2025-01", revenue: 1000 },
    { period: "2025-02", revenue: 1500 },
  ],
  forecast: [
    { period: "2025-03", p10: 800, p50: 1200, p90: 1600 },
    { period: "2025-04", p10: 900, p50: 1400, p90: 1900 },
  ],
  summary: {
    trend: "up",
    nextPeriodP50: 1200,
...
describe("buildRevenueForecastCsv", () => {
  ...
  it("escapa períodos com vírgula", () => {
    const csv = buildRevenueForecastCsv({
      ...fixture,
      history: [{ period: "Q1,2025", revenue: 10 }],
      forecast: [],
    });
  ...
  it("deixa em branco valores não-finitos", () => {
    const csv = buildRevenueForecastCsv({
      ...fixture,
      forecast: [{ period: "2025-05", p10: NaN, p50: 100, p90: Infinity }],
      history: [],
    });

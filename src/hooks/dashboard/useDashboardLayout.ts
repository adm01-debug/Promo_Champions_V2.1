...
export const AVAILABLE_WIDGETS: {
...
}[] = [
  {
    ...
    description: 'KPI de receita atual vs meta',
    icon: '💰',
    defaultW: 1,
    defaultH: 1,
  },
  {
    ...
    title: 'Funil de Pipeline',
    description: 'Distribuição de deals por stage',
    icon: '📊',
    defaultW: 2,
    defaultH: 2,
  },
  {
    ...
    description: 'Resumo de atividades do dia',
    icon: '📋',
    defaultW: 1,
    defaultH: 1,
  },
  {
    type: 'top_deals',
    title: 'Top Deals',
    description: 'Maiores oportunidades ativas',
    icon: '⭐',
    defaultW: 2,
    defaultH: 2,
  },
  {
    ...
    description: 'Conversão por período',
    icon: '📈',
    defaultW: 1,
    defaultH: 1,
  },
  {
    ...
    description: 'Últimas atividades registradas',
    icon: '🕐',
    defaultW: 2,
    defaultH: 2,
  },
  {
    ...
    description: 'Barra de progresso da meta mensal',
    icon: '🎯',
    defaultW: 1,
    defaultH: 1,
  },
  {
    ...
    description: 'Posição no ranking de vendas',
    icon: '🏆',
    defaultW: 1,
    defaultH: 2,
  },
  {
    ...
    title: 'Forecast',
    description: 'Previsão de receita ponderada',
    icon: '🔮',
    defaultW: 1,
    defaultH: 1,
  },
  {
    ...
    title: 'Calendário',
    description: 'Próximas atividades agendadas',
    icon: '📅',
    defaultW: 2,
    defaultH: 2,
  },
  {
    ...
    description: 'Embute um relatório do Builder no dashboard',
    icon: '📑',
    defaultW: 2,
    defaultH: 2,
  },
  {
    ...
    description: 'Insights e dicas táticas da IA em tempo real',
    icon: '🧠',
    defaultW: 2,
    defaultH: 1,
  },

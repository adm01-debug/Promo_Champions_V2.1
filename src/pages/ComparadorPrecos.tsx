      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-[1600px] mx-auto p-6 lg:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <Card className="glass border-border/40"><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Package className="h-4 w-4" />Produtos Comparados</CardTitle></CardHeader><CardContent><div className="text-metric">{totalProducts}</div></CardContent></Card>
            <Card className="glass border-border/40"><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><DollarSign className="h-4 w-4" />Total de Cotações</CardTitle></CardHeader><CardContent><div className="text-metric">{supplierProducts?.length || 0}</div></CardContent></Card>
            ...
            <Card className="glass border-border/40"><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Star className="h-4 w-4" />Fornecedores Ativos</CardTitle></CardHeader><CardContent><div className="text-metric">{new Set(supplierProducts?.map((sp) => sp.supplier_id)).size}</div></CardContent></Card>
            <Card className="glass border-border/40"><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><History className="h-4 w-4" />Histórico de Preços</CardTitle></CardHeader><CardContent><div className="text-metric">{priceHistory?.length || 0}</div></CardContent></Card>
          </div>

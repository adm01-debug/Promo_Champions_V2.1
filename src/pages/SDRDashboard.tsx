...
import {
  ...
  useRebuildQueue,
  useNextItem,
} from '@/hooks/dialer/usePowerDialer';
...
export default function SDRDashboard() {
  ...
  const rejectionRate =
    totalLeads > 0 ? ((totalLeads - qualifiedLeads) / totalLeads) * 100 : 0;
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-8">
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <Badge
                            variant="outline"
                            className="h-5 px-1.5 text-[10px] font-bold border-primary/30 text-primary animate-pulse"
                          >
                            SDR 10/10
                          </Badge>
                        </div>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className="relative h-full">
                        <SchedulingRateGauge
                          rate={
                            ((metrics?.current.qualifiedLeads ?? 0) /
                              (metrics?.current.totalLeads || 1)) *
                            100
                          }
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        {queues && queues.length > 0 ? (
                          ...
                          <div className="p-12 text-center glass rounded-xl border border-dashed border-border/50">
                            <p className="text-sm text-muted-foreground">
                              Nenhuma fila de prospecção configurada.
                            </p>
                          </div>
                        )}
                      </div>
                        ...
                        {currentItem ? (
                          ...
                          <div className="h-full flex flex-col items-center justify-center p-8 glass rounded-xl border border-border/30 bg-muted/5 text-center">
                            ...
                            <p className="text-[10px] text-muted-foreground/60 mt-1">
                              Inicie uma fila para começar a prospecção acelerada
                            </p>
                          </div>
                        )}
                      </div>

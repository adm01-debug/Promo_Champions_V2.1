  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Visualização completa do funil de vendas com conversão, drop-off e tempo médio."
        />
      </Helmet>
      <PageTransition>
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Conversão, drop-off e gargalos por estágio
              </p>
            </div>
            <Select
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    {isTopDrop && (
                                      <Badge
                                        variant="destructive"
                                        size="sm"
                                        className="h-4 px-1 text-[8px] animate-pulse"
                                      >
                                        GARGALO CRÍTICO
                                      </Badge>
                                    )}
                              ...
                              <div className="flex flex-col items-end gap-1">
                                <TooltipProvider>
                                  <Tooltip>
                                    ...
                                    <TooltipContent>
                                      Taxa de conversão para esta etapa
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                            ...
                            <div className="mt-4 h-1.5 w-full bg-muted/30 rounded-full overflow-hidden relative">
                              <motion.div
                                ...
                                className={cn(
                                  ...
                                  stage.conversionRate >= 60
                                    ? 'bg-status-success shadow-[0_0_8px_rgba(34,197,94,0.4)]'
                                    : stage.conversionRate >= 30
                                      ? 'bg-status-warning'
                                      : 'bg-destructive'
                                )}
                ...
                <motion.div variants={itemVariants} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-3 rounded-lg bg-primary/5 border border-primary/10">
                        <p className="text-[11px] leading-relaxed text-muted-foreground italic">
                          "O algoritmo detectou uma desaceleração incomum na etapa de{' '}
                          <span className="text-primary font-bold">
                            {data.topDropOffStage}
                          </span>
                          . Recomendamos ação imediata com Battlecards de fechamento."
                        </p>
                      </div>
                  ...
                  <Card className="p-5 glass border-border/40">
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex gap-3 text-xs text-muted-foreground group cursor-pointer hover:text-foreground transition-colors"
                        >
                  ...
                  <Card className="p-5 glass border-border/40 overflow-hidden relative group">
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent>
                                ...
                                <p className="text-[8px]">
                                  Velocidade: {stage.velocityScore}%
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                    ...
                    <p className="mt-3 text-[10px] text-muted-foreground leading-tight">
                      O calor indica fluidez. Zonas azuis sugerem leads "estacionados"
                      precisando de follow-up.
                    </p>
                  </Card>
                </motion.div>
              </div>

...
import { ClipboardList, Bell, Trophy, Target } from 'lucide-react';
    ...
    <PageTransition>
      <>
        <Helmet>
          ...
          <meta
            name="description"
            content="Registro e acompanhamento de atividades comerciais"
          />
        </Helmet>
        <SkeletonTransition
          isLoading={isLoading}
            ...
            <div className="max-w-[1600px] mx-auto p-6 lg:p-8 space-y-6">
              ...
              <Tabs defaultValue="overview" className="space-y-6">
                <TabsList className="bg-muted/30 border border-border/40 p-1">
                  ...
                  <TabsTrigger
                    value="performance"
                    className="text-xs font-bold uppercase tracking-wider px-6 flex items-center gap-2"
                  >

...
import { useActivityGoalProgress } from '@/hooks/activities/useActivityGoals';
                  ...
                  <div className="space-y-4 relative z-10">
                      ...
                      <h1 className="text-6xl sm:text-8xl font-display font-black tracking-tighter gradient-text uppercase italic leading-none filter drop-shadow-glow transition-all duration-700 group-hover/arena-header:scale-[1.02] flex items-center gap-4">
                        ...
                        <div className="hidden sm:flex items-center justify-center h-20 w-20 rounded-full border-4 border-primary/20 border-t-primary animate-spin-slow p-1 relative shadow-glow-primary/20">
                          <div className="h-full w-full rounded-full bg-primary/10 flex items-center justify-center">
                            <span className="text-xl font-black text-primary tracking-widest italic animate-pulse">
                              14/10
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="text-base text-muted-foreground font-medium flex items-center gap-3 pl-1">
                      ...
                      <span>
                        ...
                        <span className="text-foreground/90 font-bold uppercase tracking-widest text-xs">
                  ...
                  <div className="flex flex-wrap items-center gap-4 relative z-10">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        toast({
                          ...
                          description:
                            'Interface simplificada para máxima produtividade.',
                        })
                      }
                    ...
                    <div className="flex flex-col items-end gap-2 group/boss-bar">
                      ...
                      <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-background/40 backdrop-blur-xl border border-white/10 text-[9px] font-black uppercase tracking-widest text-muted-foreground shadow-lg">
                        ...
                        <span>
                          Meta Diária: {completed}/{withGoals.length} Concluídas
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                {isLoading
                  ...
                  : stats.map((stat, index) => (
                      ...
                      >
                        <div
                          className={cn(
                            'absolute -top-12 -right-12 w-32 h-32 blur-3xl rounded-full transition-all opacity-10 group-hover:opacity-30 group-hover:scale-150 duration-700',
                            stat.bgColor
                          )}
                        />
                        <CardContent className="p-8 relative z-10">
                          <div className="flex items-center justify-between mb-6">
                            <div
                              className={cn(
                                'p-4 rounded-2xl shadow-xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-6',
                                stat.bgColor
                              )}
                            >
                            ...
                            <Badge
                              variant="outline"
                              className={cn(
                                'text-[10px] font-black uppercase tracking-widest border-none px-3 py-1 rounded-full shadow-sm',
                                stat.bgColor,
                                stat.color
                              )}
                            >
                          ...
                          <div>
                            <div className="flex items-baseline gap-3 mb-2">
                              <p
                                className={cn(
                                  'text-6xl font-display font-black tracking-tighter leading-none drop-shadow-glow',
                                  stat.color
                                )}
                              >
                                {stat.value}
                              ...
                              {stat.trend.startsWith('+') && (
                                <span className="text-status-success text-sm font-black animate-fire-pulse bg-status-success/20 px-2 py-0.5 rounded-full">
                                  {stat.trend}
                                </span>
                              )}
                            </div>
                            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-foreground/90 mb-2">
                              {stat.label}
                            </p>
                            <p className="text-[10px] text-muted-foreground font-medium italic opacity-80 group-hover:opacity-100 transition-opacity">
                              {stat.description}
                            </p>
                          </div>
                        </CardContent>
                            ...
                            <div className="mb-6 p-6 rounded-[2rem] bg-gradient-to-r from-rank-gold/20 via-primary/10 to-rank-gold/20 border border-rank-gold/30 shadow-glow-gold/10 animate-pulse relative overflow-hidden group">
                              ...
                              <div className="relative z-10 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div>
                                    <h4 className="text-lg font-display font-black tracking-tighter uppercase italic text-rank-gold">
                                      Membro no Hall da Fama!
                                    </h4>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-foreground/70">
                                      O pódio da arena já tem ocupantes hoje.
                                    </p>
                                  </div>
                                </div>
                              ...
                              {isLoading ? (
                                ...
                                <div className="empty-state">
                                  ...
                                  <p className="empty-state-description">
                                    Configure os pilotos para iniciar a monitoração na
                                    arena.
                                  </p>
                                </div>
                              )}

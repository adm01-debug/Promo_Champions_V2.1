...
const OnboardingTracking = () => {
  ...
  const summary = useMemo(
    () => ({
      ...
      avgProgress: tracks.length
        ? Math.round(tracks.reduce((s, t) => s + t.progress, 0) / tracks.length)
        : 0,
    }),
    [tracks]
  );
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Acompanhe a implementação e onboarding de novos clientes."
        />
      </Helmet>
      <PageTransition>
        <div className="container max-w-5xl mx-auto p-4 md:p-6 lg:p-8 space-y-6">
          <motion.div variants={itemVariants}>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Acompanhe milestones de implementação de clientes
            </p>
          </motion.div>

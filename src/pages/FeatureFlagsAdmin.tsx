  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Gerencie feature flags e rollout progressivo."
        />
      </Helmet>
      <PageTransition>
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Controle de funcionalidades com rollout progressivo
              </p>
              {testFlag && (
                <Badge
                  variant="outline"
                  className="mt-2 bg-primary/10 border-primary/20 text-primary animate-pulse"
                >
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={cn(
                        'p-2 rounded-lg',
                        flag.is_enabled ? 'bg-status-success/10' : 'bg-muted'
                      )}
                    >
                      <Flag
                        className={cn(
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              onClick={() => {
                                const roles = prompt(
                                  'Cargos permitidos (separados por vírgula):',

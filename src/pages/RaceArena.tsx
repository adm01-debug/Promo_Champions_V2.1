...
import { Settings2, Flag, Calendar } from 'lucide-react';
import { RaceArena as Arena, RaceLeaderboardSidebar, RaceEventFeed, CarCustomizer, RaceSoundToggle } from '@/components/race';
...
export default function RaceArenaPage() {
  ...
  // toca som ao chegar evento novo
  useEffect(() => {
        ...
        {!season && (
          <Card>
            <CardContent className="py-10 text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground">Peça a um administrador para iniciar uma nova temporada de corrida.</p>
            </CardContent>
          </Card>
        )}

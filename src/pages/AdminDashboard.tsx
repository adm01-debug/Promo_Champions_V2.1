      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            variant="default"
            size="sm"
            className="gap-2 shadow-lg shadow-primary/20 font-bold uppercase text-[10px]"
          >
        ...
        <div className="flex items-center justify-between">
          <TabsList className="bg-muted/30 p-1 border border-border/40 backdrop-blur-sm">
            ...
            <TabsTrigger
              ...
              className="gap-2 font-bold uppercase text-[10px]"
            >
              <Database className="h-3.5 w-3.5" /> Infraestrutura
            </TabsTrigger>
            <TabsTrigger
              value="automations"
              className="gap-2 font-bold uppercase text-[10px]"
            ...
            <TabsTrigger
              ...
              className="gap-2 font-bold uppercase text-[10px]"
            >
              <Search className="h-3.5 w-3.5" /> IA & Busca
            </TabsTrigger>
          </TabsList>
        </div>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <AdminSystemStatus
              ...
              queryMetrics={
                queryMetrics || { totalQueries: 0, avgDuration: 0, slowQueries: 0 }
              }
            />
          </div>
          <AdminQuickLinks />
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="space-y-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm font-display font-black uppercase tracking-widest italic">
                  Performance & Health
                </h3>
              </div>

...
export default function CommissionRules() {
  ...
  const handleEdit = (
    rule: Partial<CommissionRule> = { is_active: true, priority: 1, percentage: 5 }
  ) => {
    setEditingRule(rule);
    ...
    <>
      ...
      <PageTransition>
        <div className="container max-w-6xl mx-auto p-4 md:p-6 lg:p-8 space-y-6">
          ...
          >
            <div>
              <h1 className="text-page-title font-display italic uppercase tracking-tighter">
                Regras de Comissão
              </h1>
              <p className="text-sm text-muted-foreground">
                Configure os percentuais de comissão por categoria, vendedor e valor
              </p>
            </div>
            <Button
              onClick={() => handleEdit()}
              className="gradient-primary text-xs font-black uppercase tracking-widest gap-2"
            >
              ...
              <Table>
                <TableHeader className="bg-white/5">
                  <TableRow className="border-white/5">
                    <TableHead className="text-[10px] font-black uppercase tracking-widest w-[40px]">
                      Prior.
                    </TableHead>
                    ...
                    rules.map(rule => (
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex flex-wrap gap-1">
                            {rule.salesperson_id ? (
                              ...
                              <Badge
                                variant="outline"
                                className="text-[9px] bg-white/5 text-muted-foreground"
                              >
                                Todos Vendedores
                              </Badge>
                            )}
                        ...
                        <TableCell className="text-right">
                          <span className="font-black italic text-primary text-lg">
                            {rule.percentage}%
                          </span>
                        </TableCell>
                        <TableCell>
                          <Switch
                            ...
                            onCheckedChange={() =>
                              upsertRule.mutate({ ...rule, is_active: !rule.is_active })
                            }
                          />
                        </TableCell>
                        <TableCell className="text-right">
          ...
          <motion.div
            variants={itemVariants}
            className="p-4 rounded-xl bg-primary/5 border border-primary/20 flex gap-4"
          >
            ...
            <div className="text-xs space-y-1">
              ...
              <p className="text-muted-foreground">
                O sistema busca a regra mais específica primeiro. Se várias regras se
                aplicarem, a de maior <strong>prioridade</strong> vence. Caso não existam
                regras aplicáveis, o padrão é <strong>5%</strong>.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <DialogContent className="glass border-white/10 shadow-2xl max-w-xl">
          ...
          <div className="grid grid-cols-2 gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={e =>
                  setEditingRule(prev => ({ ...prev, priority: Number(e.target.value) }))
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={e =>
                  setEditingRule(prev => ({ ...prev, category: e.target.value || null }))
                }
              />
            </div>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="gradient-primary text-[10px] font-black uppercase tracking-widest px-8"
            >
              Salvar Regra
            </Button>
          </DialogFooter>

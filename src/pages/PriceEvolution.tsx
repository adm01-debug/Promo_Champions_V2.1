  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Acompanhe a evolução de preços dos produtos e alertas de variação."
        />
      </Helmet>
      <PageTransition>
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Histórico de variações de preço por produto e fornecedor
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-right">
                        ...
                        >
                          {alert.price_change_percent != null
                        ...
                        <div className="text-right">
                          <p className="text-xs">
                            ...
                            <span className="font-bold text-foreground">
                              R${h.new_price.toFixed(2)}
                            </span>
                          </p>
                          <p className="text-[10px] text-muted-foreground">
                            {format(new Date(h.recorded_at), 'dd/MM HH:mm', {
                              locale: ptBR,
                            })}
                          </p>
                        </div>

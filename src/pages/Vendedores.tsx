...
import { Trophy, Users, Zap, LayoutGrid, UserPlus } from 'lucide-react';
...
import {
  SalespersonForm,
  SalespersonRole,
} from '@/components/vendedores/SalespersonForm';
        ...
        >
          <div className="min-h-screen bg-background p-6 lg:p-8">
            <div className="max-w-[1400px] mx-auto space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Competição acirrada - {periodLabels[period]}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
              ...
              {/* Ranking List */}
              <div
                className="opacity-0 animate-fade-in-up glass rounded-xl overflow-hidden"
              ...
              >
                <div className="p-5 border-b border-border/40 bg-gradient-to-r from-primary/[0.03] to-transparent">
                  <div className="flex items-center justify-between">
                    ...
                    <Tabs
                      value={viewMode}
                      onValueChange={v => setViewMode(v as 'classic' | 'gamified')}
                    >
                ...
                {isLoading ? (
                  ...
                  <div className="p-10 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Adicione vendedores para iniciar o ranking
                    </p>
                  </div>
                ) : viewMode === 'gamified' ? (
                      ...
                      return (
                        <Link key={sp.id} to={`/vendedor/${sp.id}`}>
                          <GamificationCard
                            ...
                            levelColor={
                              gamification?.levelColor || 'from-gray-400 to-gray-500'
                            }
                            rank={sp.rank}

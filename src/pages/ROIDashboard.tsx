...
const ROIDashboard = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>ROI por Vendedor | PROMO CHAMPIONS</title>
        <meta
          name="description"
          content="Dashboard de ROI por vendedor com CAC, LTV e payback period"
        />
      </Helmet>
      <div className="p-4 lg:p-8 space-y-6">
          ...
          <div className="flex gap-1 bg-muted/50 rounded-lg p-1 border border-border/50">
            {periodOptions.map(p => (
              <button
                ...
                className={cn(
                  'px-3 py-1.5 text-sm rounded-md font-bold transition-all',
                  period === p.value
          ...
          >
            <Card className="border-none shadow-xl glass group relative overflow-hidden">
              ...
              <CardContent className="p-5 relative z-10">
                ...
                <p className="text-3xl font-black text-foreground">
                  {Math.round(animatedPayback)} dias
                </p>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mt-1">
                  Payback Médio
                </p>
        ...
        <Tabs defaultValue="ranking" className="space-y-4">
          ...
          <TabsContent value="ranking">
            <ROIRankingList roiData={roiData} />
          </TabsContent>

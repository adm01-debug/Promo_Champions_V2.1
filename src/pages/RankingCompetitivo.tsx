              ...
              {[
                {
                  ...
                  subColor: 'text-rank-gold',
                  icon: Trophy,
                  iconColor: 'text-rank-gold',
                  bg: 'from-rank-gold/20 to-rank-gold/20',
                },
                {
                  label: 'Total Equipe',
                ...
                },
                {
                  ...
                  bg: 'from-status-success/20 to-status-success/20',
                },
              ].map(stat => (
                <Card key={stat.label} className="glass border-border/50">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`h-12 w-12 rounded-full bg-gradient-to-br ${stat.bg} flex items-center justify-center`}
                      >
            ...
            <Tabs defaultValue="ranking" className="space-y-6">
              ...
              <TabsContent value="xp" className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                  {[
                    {
                      label: 'Total XP do Time',
                      value: (xpData || [])
                        .reduce((s, x) => s + (x.total_xp || 0), 0)
                        .toLocaleString(),
                    ...
                    },
                    {
                      ...
                      bg: 'from-rank-gold/20 to-primary/20',
                    },
                    {
                      label: 'Maior Nível',
                      value: String(
                ...
                {(xpData || []).map((xpRecord, index) => {
                  const salesperson = xpRecord.salespeople as {
                    id: string;
                    name: string;
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-right hidden md:block">
                            <p className="text-lg font-bold gradient-text">
                              Nv. {xpRecord.current_level || 1}
                            </p>
                            {(xpRecord.current_level || 1) < 20 && (
                              <p className="text-xs text-muted-foreground">
                                {(xpToNext - xpInLevel).toLocaleString()} XP para Nv.
                                {(xpRecord.current_level || 1) + 1}
                              </p>
                            )}
                          </div>
                        </div>
                  ...
                  <Card className="glass border-border/50">
                    <CardContent className="py-12 text-center">
                      ...
                      <p className="text-muted-foreground">
                        Nenhum vendedor com XP registrado ainda
                      </p>
                      <p className="text-sm text-muted-foreground mt-1">
                        XP é ganho através de vendas e conquistas
                      </p>
                    </CardContent>
                  </Card>
                )}

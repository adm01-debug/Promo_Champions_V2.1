  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Gestão inteligente de objeções e respostas recomendadas"
        />
      </Helmet>
      <PageTransition>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground/80">
                  Repositório central de argumentos e contornos táticos
                </p>
              </div>
            </motion.div>
          </div>
              ...
              <Card className="glass border-border/40">
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 rounded-lg bg-status-error/10 border border-status-error/20">
                    <p className="text-xs font-semibold text-status-error uppercase mb-1">
                      Preço
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Responsável por 45% das perdas no último mês. Revise as respostas de
                      "Ancoragem de Valor".
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-status-warning/10 border border-status-warning/20">
                    <p className="text-xs font-semibold text-status-warning uppercase mb-1">
                      Concorrência
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Aumento de 12% em menções ao Player X. Use a tag #player-x para
                      filtrar respostas.
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="glass border-primary/20 bg-primary/5">
                ...
                <CardContent>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Vendedores que utilizam a biblioteca têm uma taxa de conversão{' '}
                    <span className="text-foreground font-semibold">18% superior</span> em

...
import { Trophy, Flame, Star, Target, Swords, Heart, Crown, Award } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              ...
              <div className="flex-1 text-center md:text-left space-y-2">
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                  ...
                  <Badge
                    variant="outline"
                    className="bg-primary/20 text-primary border-primary/30 font-bold uppercase tracking-widest px-3"
                  >
            ...
            <div className="mt-8 relative z-10 max-w-2xl">
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-primary font-bold">
                  {(profile?.totalXp || 0) % 1000} / 1000 XP
                </span>
              </div>
              <Progress
                  ...
                  {[
                    {
                      ...
                      value: `R$ ${(profile?.totalSales || 0) / 1000}k`,
                      icon: Award,
                      color: 'text-primary',
                    },
                    {
                      label: 'Taxa de Win (H2H)',
                      value: `${profile?.h2hWins} - ${profile?.h2hLosses}`,
                      icon: Swords,
                    ...
                    {
                      label: 'Maior Streak',
                      value: `${profile?.longestStreak} dias`,
                      icon: Flame,
                    ...
                    <div
                      key={i}
                      className="flex items-center justify-between p-3 rounded-xl bg-card/50 border border-border/30 group-hover:border-primary/20 transition-all"
                    >
              ...
              <Card className="glass border-border/40 bg-gradient-to-br from-coins/10 to-transparent">
                ...
                <CardContent className="flex justify-center gap-4">
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={i}
                      className="h-16 w-16 rounded-2xl border-2 border-dashed border-coins/30 flex items-center justify-center bg-coins/5 group cursor-pointer hover:border-coins/60 transition-all"
                    >

...
const ImportExport = () => {
  ...
  const handleExport = useCallback(async () => {
    ...
    a.href = url;
    a.download = `clientes_export_${getLocalISODate()}.csv`;
    a.click();
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Importe clientes via CSV ou exporte sua base
              </p>
            </div>
          ...
          {step === 'upload' && (
            <motion.div variants={itemVariants}>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Suporta CSV e TSV com cabeçalhos
                </p>
                <input
                  ref={fileRef}
                  type="file"
            ...
            <motion.div variants={itemVariants}>
              <Card className="p-4 glass border-border/40 space-y-3">
                <p className="text-sm font-semibold">
                  {rows.length} registros encontrados. Mapeie os campos:
                </p>
                {mappings.map((m, i) => (
            ...
            <motion.div variants={itemVariants}>
              <Card className="p-4 glass border-border/40 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Total: {rows.length} registros serão importados
                </p>
          ...
          {step === 'complete' && (
            <motion.div variants={itemVariants}>
              <Card className="p-8 glass border-border/40 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Dados disponíveis na base de clientes
                </p>
                <Button
                  className="mt-4"
                  onClick={() => {

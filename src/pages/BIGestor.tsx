          ...
          <div className="min-h-screen bg-background">
            <div className="max-w-[1600px] mx-auto p-6 lg:p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    value: String(data?.activeSalespeople || 0),
                    icon: Users,
                  },
                  {
                    title: 'Performance Média',
                    value: `${(data?.avgPerformance || 0).toFixed(0)}%`,
                    icon: BarChart3,
                  },
                ].map((stat, index) => (
                  <div
                    ...
                    >
                      ...
                      <CardContent className="p-4 relative">
                        ...
                        {stat.change !== undefined && (
                          ...
                          >
                            {stat.change > 0 && '+'}
                            {stat.change.toFixed(1)}% vs mês anterior
                          </span>
                        )}
                        {stat.progress !== undefined && (
                          <div className="mt-2">
                            ...
                            <span className="text-xs text-muted-foreground">
                              {stat.progress.toFixed(0)}% da meta
                            </span>
                          </div>
                        )}
                      </CardContent>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card
                  className="lg:col-span-2 glass-card animate-slide-up"
                            ...
                            >
                              <div
                                ...
                                style={{
                                  backgroundColor:
                                    ABC_COLORS[
                                      abc.classification as keyof typeof ABC_COLORS
                                    ],
                                }}
                              />
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 rounded-xl glass hover-scale-sm">
                        <p className="text-2xl font-black">
                          {(data?.avgDaysInPipeline || 0).toFixed(0)}d
                        </p>
                      ...
                      {data?.dealsByStage.map((stage, idx) => (
                        ...
                        >
                          ...
                          <Progress
                            value={
                              stage.count > 0
                                ? (stage.value / (data?.totalPipelineValue || 1)) * 100
                                : 0
                            }
                            className="h-2"
                          />

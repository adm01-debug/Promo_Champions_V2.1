          ...
          <TabsContent value="navitem" className="mt-6 space-y-6">
            <Card className="border-primary/10 bg-background/40 backdrop-blur-md">
              <CardHeader>
                ...
                <CardDescription>
                  Componente de navegação lateral com feedback visual premium e
                  micro-interações.
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm list-disc list-inside text-muted-foreground">
                      ...
                      <li>
                        Badges devem ser usados para sinalizar itens pendentes ou novos
                        dados.
                      </li>
                      <li>
                        O estado ativo injeta automaticamente um glow neon via Framer
                        Motion.
                      </li>
                      <li>
                        Sempre forneça um{' '}
                        <code className="bg-muted px-1 rounded">title</code> descritivo
                        para o tooltip.
                      </li>
                    </ul>
                  </div>
          ...
          <TabsContent value="statcard" className="mt-6 space-y-6">
            <Card className="border-primary/10 bg-background/40 backdrop-blur-md">
              <CardHeader>
                ...
                <CardDescription>
                  Cartões de dados com contagem animada, sparklines e estética
                  Cyber-Arena.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm list-disc list-inside text-muted-foreground">
                      <li>
                        Use <code className="bg-muted px-1 rounded">hero</code> apenas
                        para a métrica principal da página.
                      </li>
                      <li>
                        Forneça{' '}
                        <code className="bg-muted px-1 rounded">numericValue</code> para
                        habilitar a animação de contagem (FPS otimizado).
                      </li>
                      <li>
                        Sparklines ajudam a entender a tendência sem ocupar espaço extra.
                      </li>
                      <li>
                        Variantes (primary, success, warning) devem seguir a semântica do
                        dado.
                      </li>
                    </ul>
                  </div>
          ...
          <TabsContent value="transitions" className="mt-6 space-y-6">
            <Card className="border-primary/10 bg-background/40 backdrop-blur-md">
              <CardHeader>
                ...
                <CardDescription>
                  Sistemas de orquestração visual para transições suaves e carregamento
                  progressivo.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm list-disc list-inside text-muted-foreground">
                      ...
                      <li>
                        A transição detecta automaticamente a profundidade da URL para
                        definir a direção do slide.
                      </li>
                      <li>
                        Use <code className="bg-muted px-1 rounded">SmartSkeleton</code>{' '}
                        em carregamentos assíncronos para reduzir o Layout Shift.
                      </li>
                      <li>
                        A propriedade{' '}
                        <code className="bg-muted px-1 rounded">will-change</code> é
                        aplicada em transições críticas para garantir 60 FPS.
                      </li>
                    </ul>
                  </div>
                </div>

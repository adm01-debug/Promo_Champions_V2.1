...
export default function AccountBasedSelling() {
  ...
  const [ctForm, setCtForm] = useState({
    ...
    email: '',
    job_title: '',
    buying_role: 'user' as BuyingRole,
    influence_level: 3,
  });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Gestão estratégica de contas com hierarquia, buying committee e account scoring."
        />
      </Helmet>
      ...
      <div className="container mx-auto p-6 space-y-6">
        <header className="flex items-center justify-between">
          ...
          <Dialog open={newAccountOpen} onOpenChange={setNewAccountOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Nova Conta Estratégica</DialogTitle>
              </DialogHeader>
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Select
                    value={accForm.tier}
                    onValueChange={v =>
                      setAccForm({ ...accForm, tier: v as AccountTier })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Input
                    value={accForm.industry}
                    onChange={e => setAccForm({ ...accForm, industry: e.target.value })}
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      type="number"
                      value={accForm.annual_revenue}
                      onChange={e =>
                        setAccForm({ ...accForm, annual_revenue: e.target.value })
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      type="number"
                      value={accForm.employee_count}
                      onChange={e =>
                        setAccForm({ ...accForm, employee_count: e.target.value })
                      }
                    />
                  </div>
                </div>
              ...
              <DialogFooter>
                <Button
                  ...
                  disabled={!accForm.name || createAccount.isPending}
                >
                  Criar
                </Button>
              </DialogFooter>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-1">
            <CardHeader>
              <CardTitle>Contas ({accounts?.length ?? 0})</CardTitle>
            </CardHeader>
              ...
              {accounts?.map(a => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={healthVariant(a.health_status)}>
                      {a.account_score}
                    </Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => recalc.mutate(selected.id)}
                        disabled={recalc.isPending}
                      >
                        <RefreshCw
                          className={`h-4 w-4 ${recalc.isPending ? 'animate-spin' : ''} mr-2`}
                        />{' '}
                        Score
                      </Button>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <Card variant="outlined">
                          <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                            ...
                            <Badge
                              variant={healthVariant(selected.health_status)}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm font-medium">
                            {selected.industry || 'Não informado'}
                          </p>
                        </div>
                        <div className="space-y-1">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm font-medium">
                            {selected.annual_revenue
                              ? `R$ ${selected.annual_revenue.toLocaleString()}`
                              : '—'}
                          </p>
                        </div>
                        <div className="space-y-1">
                    ...
                    <TabsContent value="committee" className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Dialog open={newContactOpen} onOpenChange={setNewContactOpen}>
                          <DialogTrigger asChild>
                            <Button size="sm">
                              <Plus className="h-4 w-4 mr-1" /> Stakeholder
                            </Button>
                          </DialogTrigger>
                          <DialogContent>
                            <DialogHeader>
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <Input
                                  value={ctForm.name}
                                  onChange={e =>
                                    setCtForm({ ...ctForm, name: e.target.value })
                                  }
                                />
                              </div>
                              <div>
                                ...
                                <Input
                                  ...
                                  value={ctForm.email}
                                  onChange={e =>
                                    setCtForm({ ...ctForm, email: e.target.value })
                                  }
                                />
                              </div>
                              <div>
                                <Label>Cargo</Label>
                                <Input
                                  value={ctForm.job_title}
                                  onChange={e =>
                                    setCtForm({ ...ctForm, job_title: e.target.value })
                                  }
                                />
                              </div>
                              <div>
                                <Label>Papel</Label>
                                <Select
                                  value={ctForm.buying_role}
                                  onValueChange={v =>
                                    setCtForm({ ...ctForm, buying_role: v as BuyingRole })
                                  }
                                >
                                  <SelectTrigger>
                                    <SelectValue />
                            ...
                            <DialogFooter>
                              <Button
                                ...
                                disabled={!ctForm.name || createContact.isPending}
                              >
                                Mapear
                              </Button>
                            </DialogFooter>
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                  {c.job_title || 'Sem cargo'} ·{' '}
                                  {roleLabel[c.buying_role]}
                                </p>
                              </div>
                            </div>
...
function AccountPlanSection({ accountId }: { accountId: string }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold flex items-center gap-2">
          <FileText className="h-4 w-4" /> Account Plan
        </h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card className="p-4 bg-red-500/5" variant="outlined">
            <Label className="text-red-700 flex items-center gap-2">
              <Shield className="h-3 w-3" /> Fraquezas
            </Label>
            <Textarea

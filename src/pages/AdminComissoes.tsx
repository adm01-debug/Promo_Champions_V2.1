...
import { CheckCircle, XCircle, Search, FileText, Wallet, Settings } from 'lucide-react';
          ...
          >
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Aprovação e pagamento de comissões de vendas
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Link to="/admin/regras-comissao">
                <Button
                  variant="outline"
                  className="border-white/10 bg-white/5 text-xs font-black uppercase tracking-widest gap-2"
                >
                          ...
                          <TableCell>
                            <Badge
                              ...
                              className={cn(
                                ...
                                statusBadge[c.status].className
                              )}
                            >
                            ...
                            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              {(c.status === 'pending' || c.status === 'approved') && (
                                <Button
                                  ...
                                  onClick={() => handleAction(c, 'cancelled')}
                                  title="Cancelar"
                                >
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                Notas de Pagamento / Observações
              </label>
              <Textarea
              ...
              <div className="p-3 rounded-lg bg-white/5 border border-white/5 text-[10px] space-y-1">
                <p className="flex justify-between">
                  ...
                  <span className="font-bold">
                    {format(new Date(selectedCommission.approved_at), 'dd/MM/yyyy HH:mm')}
                  </span>
                </p>
                {selectedCommission.paid_at && (
                  <p className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {format(new Date(selectedCommission.paid_at), 'dd/MM/yyyy HH:mm')}
                    </span>
                  </p>
                )}
              </div>

          ...
          <div className="opacity-0 animate-fade-in-up glass rounded-xl p-4" style={{ animationDelay: "100ms" }}>
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <Input 
                  placeholder="Buscar clientes por nome, empresa, e-mail..." 
                    ...
                    >
                      ...
                      {prediction && prediction.nextPurchaseDate && (
                        <div className={cn(
                          ...
                          prediction.urgency === 'high' ? "bg-rose-500/10 border-rose-500/20" :
                          prediction.urgency === 'medium' ? "bg-amber-500/10 border-amber-500/20" :
                          "bg-emerald-500/5 border-emerald-500/20"
                        )}>
                          <div className={cn(
                            "p-2 rounded-lg",
                            prediction.urgency === 'high' ? "bg-rose-500/20" :
                            prediction.urgency === 'medium' ? "bg-amber-500/20" :
                            "bg-emerald-500/10"
                          )}>
                            <BrainCircuit className={cn(
                              "h-4 w-4",
                              prediction.urgency === 'high' ? "text-rose-500 animate-pulse" :
                              prediction.urgency === 'medium' ? "text-amber-500" :
                              "text-emerald-500"
                            )} />
                          </div>
                          <div>
                            <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground">Previsão de Compra</p>
                          ...
                          <div className="ml-auto text-right">
                            <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground">Confiança</p>
                            <p className="text-xs font-bold text-primary">{Math.round(prediction.confidence * 100)}%</p>
                          </div>
                        </div>
                      )}

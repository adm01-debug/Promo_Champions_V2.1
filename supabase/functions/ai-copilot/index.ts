...
serve(async (req) => {
  ...
  try {
    const { context, salespersonId, action } = await req.json();
    ...
    const systemPrompt = `Você é o Copilot do CHAMPION's GIFT By Promo Brindes, um assistente de vendas ultra-conciso e proativo.

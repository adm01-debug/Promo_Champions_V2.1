...
BEGIN
  ...
  -- 4) Autorização (admin OU vendedor dono ativo)
  ...
  INSERT INTO public.sales (
    client_name, product, total_value, quantity,
    salesperson_id, sale_date, status, notes
  ) VALUES (
    v_quote.client_name,
    ...
    now(),
    'confirmed',
    'Convertido do orçamento ' || COALESCE(v_quote.quote_number, _quote_id::text)
  ) RETURNING id INTO v_sale_id;

  -- 10) Cria o pedido com número atômico + retry defensivo
  LOOP

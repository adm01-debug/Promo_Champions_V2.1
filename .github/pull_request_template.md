...
## 🗄️ Evidência Pós-Aplicação

<!--
  OBRIGATÓRIO se esta PR altera supabase/migrations/** ou supabase/functions/**.
  "Mesclado no GitHub" não é "aplicado em produção" — ver docs/execucao/HARDENING_CANONICO_2026-08-31.md
  e docs/estado/AFIRMACOES_NAO_VERIFICADAS.md para os episódios em que essa distinção foi ignorada.
  Cole a consulta/comando executado, a saída literal e o horário do servidor (não o seu).
-->

- [ ] Não aplicável — esta PR não toca `supabase/migrations/**` nem `supabase/functions/**`
